  ...
  const sectors = {
    "සමාජ පරිසරය (Social Environment)": {
      ...
      "ශාරීරික සුවතාවය සහ විනෝදාශ්වාදය සඳහා ප්‍රදේශ": {
            ...
            canDeleteRows: true,
            tableColumns: [
                { header: "ග්‍රාම නිලධාරි වසම තුළ පිහිටා ඇත්ද (ඔව්/නැත)",type: "text" },
      ...
      "කෘෂිකර්මාන්ත (Agriculture)": {
        "ආහාර භෝග නිෂ්පාදනය": {
          ...
          tableColumns: [
            ...
            { header:"ජල කළමනාකරණය සහිත වගා ඉඩම් ප්‍රමාණය (අක්කර)",type: "number" },
            { header:"අක්කරයකින් ලැබෙන වාර්ෂික ඵලදාව (කිග්‍රැ)",type: "number" },
    ...
    "ස්වභාවික ආපදා": {
        ...
        canDeleteRows: true,
        tableColumns: [
            { header:"පසුගිය වසරේ වගා හානි වූ ඉඩම් ප්‍රමාණය (අක්කර)",type: "number" },
            { header:"පසුගිය වසරේ වගා හානි තක්සේරු වටිනාකම (රු.)",type: "number" },
        ],
        mainRows: [
    ...
    "සත්ව හානි": 
    {
        ...
        "කෘෂිකාර්මික ඉඩම්": {
          ...
          tableColumns: [
            ...
            { header:"ඉඩම් ඔප්පු නොමැති වගා ඉඩම් ප්‍රමාණය (අක්කර)",type: "number" },
            { header:"වගා ඉඩම් මැනුම් අවසන් කර ඇති ප්‍රමාණය (අක්කර)",type: "number" },
            { header:"වගා ඉඩම් මැනුම් කිරීමට ඇති ප්‍රමාණය (අක්කර)",type: "number" },
            { header:"ගොවි කටයුතු සඳහා සංවර්ධනය කළ හැකි නව ඉඩම් ප්‍රමාණය (අක්කර)",type: "number" },
            { header:"ගෙවතු වගා කටයුතු සඳහා සංවර්ධනය කළ හැකි ඉඩම් ප්‍රමාණය (අක්කර)",type: "number" },
          ],
        },
        "වගා නොකර අතහැර දමා ඇති වගාබිම්": {
          ...
          tableColumns: [
            ...
            { header:"මුළු වගා ඉඩම් ප්‍රමාණය (අක්කර)",type: "number" },
            { header:"අතහැර දමා ඇති කාලය",type: "text" },
            { header:"ගොවි කටයුතු සඳහා සංවර්ධනය කළ හැකි/නොහැකි බව",type: "text" },
        ...
        "වාරි මාර්ග පද්ධති": {
          ...
          tableColumns: [
            ...
            { header:"පෝෂණය කළ හැකි මුලු ඉඩම් ප්‍රමාණය (අක්කර)",type: "number" },
            { header:"පෝෂණය වන මුලු ඉඩම් ප්‍රමාණය (අක්කර)",type: "number" },
            { header:"ගම තුළ පවතින මුලු වගා ඉඩම් වලින් පෝෂණය වන ඉඩම් ප්‍රමාණය (%)",type: "number" },
            { header:"වර්තමාන තත්වය (නඩත්තුවක් අවශ්‍ය නැත/අවශ්‍යයි/පිළිසකර කළ යුතුයි)",type: "text" },
          ],
        },
      },
      ...
      "ධීවර කර්මාන්තය (Fisheries Industry)": {
                ...
                tableColumns: [
                  ...
                  { header:"පන්න වර්ගය (දැල් වර්ග)",type: "text" },
                   { header:"සාමාන්‍ය දෛනික මත්ස්‍ය අස්වැන්න (කි.ග්‍රෑ)",type: "number" },
                   { header:"දෛනික කරවල, උම්බලකඩ ආදී නිෂ්පාදන (කි.ග්‍රෑ)",type: "number" },
               ],
                mainRows: [
    ...
    "මානව සම්පත් සංවර්ධනය (HR Development)": {
      "අධ්‍යාපනයට ඇති ප්‍රවේශය": {
        ...
        secondaryTable: {
            ...
            tableColumns: [
                ...
                { header:"ගමෙන් බැහැර පිහිටි පාසැල් වල අධ්‍යාපන ලබන සිසුන් සංඛ්‍යාව",type: "number" },
                { header:"පාසල් යාම සදහා කී. මී. 10කට වඩා දුරක් ගමන් කරන සිසුන් සංඛ්‍යාව",type: "number" },
                { header:"පාසැල් අධ්‍යාපනය අතර මග අතහැර දැමූ සිසුන් සංඛ්‍යාව",type: "number" },
                { header:"කවර හෝ අධ්‍යාපන ශිෂ්‍යාධාරයක් හිමි සිසුන් ගණන",type: "number" },
                { header:"අධ්‍යාපන ශිෂ්‍යාධාරයක් ඉල්ලුම් කර ඇති සිසුන් ගණන", type: "number" },
            ]
        }
    },
      "තොරතුරු තාක්ෂණ සේවා": {
      ...
      "කුසලතා (Skills)": {
           isTable: true,
            ...
            tableColumns: [
                ...
                { header:"තාක්ෂණික / වෘත්තීය අධ්‍යාපනයට ඇතුළත් වූ සංඛ්‍යාව",type: "number" },
                { header:"තාක්ෂණික / වෘත්තීය අධ්‍යාපන සුදුසුකම් සපුරා ඇති සංඛ්‍යාව",type: "number" },
                { header:"පසුගිය වසරේ විශ්ව විද්‍යාල අධ්‍යාපනයට ඇතුළත් වූ සිසුන් සංඛ්‍යාව",type: "number" },
                { header:"උසස් අධ්‍යාපනයට හෝ තාක්ෂණික අධ්‍යාපනයට යොමු නොවූ වයස අවුරුදු 18-30 ත් අතර තරුණයින් සංඛ්‍යාව",type: "number" },
            ],
        },
      "ක්‍රීඩා සහ වෙනත් කුසලතා": {
        ...
        tableColumns: [
          ...
          { header:"දිස්ත්‍රික් මට්ටමෙන්  ලද ජයග්‍රහණ සංඛ්‍යාව",type: "number" },
    ...
    "රැකවරණය (Protection)": {
      "රැකවරණය අවශ්‍ය පුද්ගලයන්": {
       ...
       tableColumns: [
            ...
            { header:"රැකවරණයක් නොමැති වැඩිහිටියන් සංඛ්‍යාව (අවු. 70 වැඩි) (ස්ත්‍රී)",type: "text" },
            { header:"රැකවරණයක් නොමැති වැඩිහිටියන් සංඛ්‍යාව (අවු. 70 වැඩි) (පුරුෂ)",type: "text" },
            { header:"ආධාර අවශ්‍ය ආබාධිත හා විශේෂ අවශ්‍යතා සහිත පුද්ගලයින් සංඛ්‍යාව (ස්ත්‍රී)",type: "text" },
            { header:"ආධාර අවශ්‍ය ආබාධිත හා විශේෂ අවශ්‍යතා සහිත පුද්ගලයින් සංඛ්‍යාව (පුරුෂ)",type: "text" },
        ],
    },
      "විශේෂිත රෝගාබාධ": {
        canDeleteRows: true,
        ...
        finalRows: [
            { id: "severe_disease_assistance", label: "ආධාර අවශ්‍ය දරුණු රෝගාබාධ වලින් පෙළෙන්නන්ගේ සංඛ්‍යාව (රෝගී තත්වය සඳහන් කරන්න)" }
        ]
    },
      "සමාජ ආරක්ෂණය සහ සංහිඳියාව": {
        canDeleteRows: true,
            ...
            tableColumns: [
              { header:"ග්‍රාම නිලධාරි වසම තුළ පිහිටා ඇති සංඛ්‍යාව",type: "number" },
              { header:"භාවිතා කරන්නන් සංඛ්‍යාව",type: "number" },
              { header:"වසම තුළ නොමැති නම් ළඟාවීමට ඇති ආසන්නම දුර (කි.මි.)",type: "number" },
            ...
            mainRows: [
                ...
                { id: "community_halls", label: "ප්‍රජාවට රැස්විය හැකි ස්ථාන (පොදු ශාලා)" }
            ],
            dynamicRow: {
       ...
       "විරැකියාව (Unemployment)": {
                ...
                tableColumns: [
                    { header: "සිංහල (කාන්තා)", type: 'number' }, { header: "සිංහල (පිරිමි)", type: 'number' },
                    { header: "දෙමළ (කාන්තා)", type: 'number' }, { header: "දෙමළ (පිරිමි)", type: 'number' },
                    { header: "මුස්ලිම් (කාन्තා)", type: 'number' }, { header: "මුස්ලිම් (පිරිමි)", type: 'number' },
                    { header: "වෙනත් (කාන්තා)", type: 'number' }, { header: "වෙනත් (පිරිමි)", type: 'number' }
                ],
                mainRows: [
                    { id: "unemployed_olevel", label: "සාමාන්‍ය පෙළ හෝ ඊට ඉහළ අධ්‍යාපනයක් ලත් විරැකියාවෙන් පෙළෙන සංඛ්‍යාව" },
                    { id: "unemployed_below_olevel", label: "සාමාන්‍ය පෙළ දක්වා පමණක් හෝ ඊට අඩු අධ්‍යාපනයක් ලත් විරැකියාවෙන් පෙළෙන සංඛ්‍යාව" },
                    { id: "unemployed_disabled", label: "ආබාධිත තත්වයක් හේතුවෙන් විරැකියාවෙන් පෙළෙන සංඛ්‍යාව" }
                ]
      ...
      "රජයේ සහන යෝජනා ක්‍රම": {
                ...
                mainRows: [
                    ...
                    { id: "disabled_person_allowance", label: "ආබාධිත පුද්ගලයන් සඳහා වන ආධාර පමණක්" }
                ],
                dynamicRow: {
