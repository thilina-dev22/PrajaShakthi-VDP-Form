...
const SubmissionList = () => {
  ...
  //ADDED: Handle delete functionality ⭐
  const handleDelete = async (id) => {
    if (
      ...
      try {
        ...
        // Refresh the list by filtering out the deleted submission from the current state
    ...
    return (
      <div>
        ...
        <p>
          ...
          {submission.selection?.subCategory || "N/A"}
        </p>
  ...
  return (
    <div className="submission-list-container">
      ...
      <div className="admin-tabs">
        <button
          className={activeTab === "council_info" ? "active" : ""}
      ...
      {error && (
        <div className="submission-card" style={{ color: "red" }}>
          Error: {error}
        </div>
      )}
      ...
      {!loading &&
        ...
        submissions.map((submission) => (
          <div key={submission._id} className="submission-card">
            ...
            {/* ⭐ ADDED: Delete button inside the card ⭐ */}
            <div
